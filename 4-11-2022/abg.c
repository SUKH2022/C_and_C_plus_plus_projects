...
/*
The given bill template was: Thanks for {{name}} for purchasing {{item}} from our {{outlet}}.Please visit our outlet {{outlet}} for any kind of problem. We plan to server you again soon.
The actual bill generated is: Thanks for Harry for purchasing Table Fan from our Ram Laxmi fan outlet.Please visit our outlet Ram Laxmi fan outlet for any kind of problem. We plan to server you again soon.
